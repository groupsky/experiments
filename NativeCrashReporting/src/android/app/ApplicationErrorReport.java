 ...
 * <ul>
 * <li> {@link #TYPE_NONE} uninitialized instance of
 * {@link ApplicationErrorReport}.
 * <li> {@link #TYPE_CRASH} application crash. Information about the crash is
 * stored in {@link #crashInfo}.
 * <li> {@link #TYPE_ANR} application not responding. Information about the ANR
 * is stored in {@link #anrInfo}.
...
public class ApplicationErrorReport implements Parcelable {
	...
	// 1 = allow )
	static final String SEND_ACTION_APP_ERROR = "send_action_app_error";
	 ...
	 * {@link #TYPE_CRASH}, {@link #TYPE_ANR}, {@link #TYPE_BATTERY}, or
	 * {@link #TYPE_RUNNING_SERVICE}.
	 */
	public int type;
	 ...
	 * report pertains to. This identifies which market the application came
	 * from.
	 */
	...
	/**
	 * If this report is of type {@link #TYPE_CRASH}, contains an instance of
	 * CrashInfo describing the crash; otherwise null.
	 */
	public CrashInfo crashInfo;

	/**
	 * If this report is of type {@link #TYPE_ANR}, contains an instance of
	 * AnrInfo describing the ANR; otherwise null.
	 */
	public AnrInfo anrInfo;

	/**
	 * If this report is of type {@link #TYPE_BATTERY}, contains an instance of
	 * BatteryInfo; otherwise null.
	 */
	public BatteryInfo batteryInfo;

	/**
	 * If this report is of type {@link #TYPE_RUNNING_SERVICE}, contains an
	...
	/**
	 * Create an instance of {@link ApplicationErrorReport} initialized from a
	 * parcel.
	 */
	...
	public static ComponentName getErrorReportReceiver(Context context,
		...
		ComponentName result = getErrorReportReceiver(pm, packageName,
				candidate);
		if (result != null) {
			return result;
		}
		...
		if ((appFlags & ApplicationInfo.FLAG_SYSTEM) != 0) {
			candidate = SystemPropertiesProxy.get(context,
	 ...
	 */
	static ComponentName getErrorReportReceiver(PackageManager pm,
			String errorPackage, String receiverPackage) {
